  ...
  const machinery = [
    {
      ...
      specs: "Swing Over Bed - Dia1600mm, Swing Over Slide - Dia2000mm, Total Length - 7500mm",
    ...
    },
    {
      ...
      specs: "Dia 2200mm, Z axis - 1600mm",
    ...
    },
    {
      ...
      specs: "X axis - 8000mm, Y axis - 1200mm, Z axis - 1000mm",
            ...
            <div>
              <div className="mb-6 sm:mb-8 flex flex-col lg:flex-row lg:items-center lg:justify-between">
                ...
                <Button 
                  ...
                  className="w-full lg:w-auto mt-4 lg:mt-0 bg-black hover:bg-gray-800"
                >
                  See All Products
                </Button>
              </div>
