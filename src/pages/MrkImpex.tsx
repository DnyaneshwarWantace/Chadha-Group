...
import { ArrowLeft, MapPin, Factory, Cpu } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="w-full px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-black">MRK IMPEX PRIVATE LIMITED</h1>
            </div>
      ...
      <section className="bg-gradient-to-r from-black to-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Advanced CNC Manufacturing</h2>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Largest Manufacturing Unit</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Cpu className="text-gray-300" size={20} />
                  <span>German CNC Technology</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h3 className="text-3xl font-bold text-center mb-12 text-gray-900">Advanced Machinery & Equipment</h3>
