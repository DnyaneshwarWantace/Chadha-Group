...
const Index = () => {
  ...
  const Card = ({ c, large }: { c: typeof companies[0]; large?: boolean }) => (
    ...
    >
      ...
      <div className="absolute top-4 sm:top-5 right-4 sm:right-5 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-zinc-950/60 backdrop-blur-md border border-white/10 text-white/70 text-[9px] sm:text-[10px] font-semibold tracking-wide drop-shadow-lg z-10 transition-colors group-hover:bg-zinc-950/80">
