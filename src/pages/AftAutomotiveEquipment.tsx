...
const AftAutomotiveEquipment = () => {
  ...
  const machinery: { name: string; image?: string; images?: string[]; description: string }[] = [
    { name: "Pressure Die Casting Machines", image: "/images/aft/equipment/Pressure Die Casting Machines.JPG", description: "3 units for precision casting operations" },
    { name: "Industrial Furnaces", image: "/images/aft/equipment/Industrial Furnaces.JPG", description: "3 units for metal melting and heating" },
    { name: "Forming Hydraulic Press", image: "/images/aft/equipment/Forming Hydraulic Press.JPG", description: "5 units for final forming operations" },
    { name: "Powder Coating Equipment", image: "/images/aft/equipment/Powder Coating Equipment.JPG", description: "Advanced surface finishing technology" },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-zinc-800 selection:bg-slate-500/30 font-sans overflow-x-hidden flex flex-col">
      ...
      <div className="relative w-full min-h-[350px] flex flex-col justify-between border-b border-gray-200">
        <img src="/images/pressingforming_hydraulic_press_machine.JPG" alt="High-Tech Equipment" loading="lazy" className="absolute inset-0 w-full h-full object-cover opacity-15 grayscale sepia-[.1]" />
        ...
        <div className="relative z-10 px-6 sm:px-12 pb-12 pt-16 max-w-7xl mx-auto w-full text-center sm:text-left">
          ...
          <div className="mt-8 text-gray-600 max-w-xl text-xs sm:text-sm leading-relaxed border-l-[2px] border-slate-600/50 pl-5 font-medium mx-auto sm:mx-0 text-left">
            Our facility houses {machinery.length} specialized machine clusters, including high-pressure die casting and automated powder coating booth.
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-14 bg-white flex-1">
        <div className="max-w-7xl mx-auto px-6 sm:px-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            {machinery.map((m, i) => (
              <div key={m.name} className="group relative bg-[#f8f9fa] border border-gray-100 hover:border-slate-600/40 transition-all duration-500 flex flex-col h-full rounded-none">
                ...
                <div className="p-4 flex flex-col flex-1 relative">
                  ...
                  <div className="mt-auto pt-2 flex items-center justify-between border-t border-gray-100">
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Industrial Asset</span>
      ...
      <section className="relative py-12 sm:py-14 bg-[#f8f9fa] overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-2xl sm:text-5xl font-bold uppercase tracking-tighter text-zinc-800 mb-6 leading-none">
            Scale-Up <span className="text-slate-600">Production</span>
          </h2>
          <p className="text-gray-600 text-xs sm:text-sm max-w-xl mx-auto mb-10 font-medium leading-relaxed">
            Our high-tonnage casting assets are ready to fulfill your automotive manufacturing volume with flawless precision.
          </p>
